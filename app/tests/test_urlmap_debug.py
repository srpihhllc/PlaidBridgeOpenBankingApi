def test_debug_urlmap(app):
    ...
    assert any(r.endpoint == "oauth.callback_google" for r in app.url_map.iter_rules()), \
        "callback_google missing"

    assert any(r.endpoint == "oauth.callback_google_clean" for r in app.url_map.iter_rules()), \
