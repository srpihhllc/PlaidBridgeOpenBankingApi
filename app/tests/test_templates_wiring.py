...
EXCLUDED_PREFIXES = (
    ...
    "admin", "cockpit", "auth", "system", "fallback", "agent", "approval",
    "audit", "brain", "cortex", "credit", "fraud", "identity", "lender",
    "log", "model", "operator", "rate", "redis", "repair", "route",
    "schema", "sql", "statements", "telemetry", "trace", "tradeline",
