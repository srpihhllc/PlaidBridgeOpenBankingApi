...
from app.services.bank_statement_generator import (
    render_branded_bank_statement_pdf,
)
...
class MockDataService:
    ...
    MERCHANTS = [
        {
            ...
            "detailed": "GENERAL_MERCHANDISE_ONLINE_MARKETPLACE",
        },
        {
            "name": "Walmart",
            "channel": "in store",
        ...
        },
        {
            ...
            "channel": "online",
            "primary": "INCOME",
            "detailed": "INCOME_TRANSFER",
        },
    ]

    @classmethod
    def generate_mock_account_metadata(
        cls, lender_user_id: int
    ) -> dict[str, Any]:
        """
            ...
            "owners": [
                {
                    ...
                    "emails": [
                        {
                            "data": f"sandbox_{lender_user_id}@mock.local",
                            "primary": True,
                            "type": "primary",
                        }
                    ],
    ...
    @classmethod
    def generate_mock_balance(
        cls, initial: float | None = None
    ) -> dict[str, Any]:
        """
        ...
        """
        base = (
            initial if initial is not None else random.uniform(500.0, 5000.0)
        )
        ...
        return {
            ...
            "credit_limit": None,
            "overdraft_limit": 0.0,
            "last_updated_datetime": datetime.now(timezone.utc).isoformat()
            + "Z",
        }
                        ...
                        "location": (
                            {
                                ...
                                "lon": round(
                                    random.uniform(-122.5, -122.4), 4
                                ),
                            }
                            if merchant["channel"] == "in store"
                            else None
                        ),
                    }
                )
